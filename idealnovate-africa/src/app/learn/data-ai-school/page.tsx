...
const programmes = [
  ...
  },
  {
    ...
    tag: "Data & AI School",
    tagColor: "#266D67",
    title: "Generative AI for Workplace",
...
const faqs = [
  ...
  {
    q: "How does the AI Agents & Automation course work in practice?",
          ...
          <div className="flex-1 relative bg-[#163d3a] flex flex-col items-center justify-center pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-left">
                {[
                  { icon: <Cpu className="w-4 h-4" />, title: "AI Agents & Automation", students: "2,840", rating: "4.9", weeks: "6 Wks", color: "#266D67", hot: true, href: "/learn/data-ai-school/ai-agents" },
