...
import {
  ...
  ShoppingBag, Laptop, Headphones, Smartphone, Monitor, Package,
} from "lucide-react";
...
const programmes = [
  ...
  },
  {
    ...
    tag: "Management School",
    tagColor: "#266D67",
    title: "Digital Accounting and Book-keeping",
...
const testimonials = [
  ...
  },
  {
    ...
    text: "The Product Management programme gave me a completely new lens on how to build products. I now think in systems, not features — and that shift has been the difference between good and exceptional outcomes.",
    rating: 5,
    avatar: "EM",
    color: "#f9ba48",
  },
...
const faqs = [
  ...
  {
    q: "How does the Product Management programme prepare me for AI-driven product roles?",
    a: "AI fluency is embedded across the curriculum — not bolted on at the end. You'll learn how to evaluate AI use cases, incorporate AI tools into product discovery and prioritisation, and lead teams building AI-powered features. Graduates are equipped to manage products in companies where AI is a core part of the roadmap.",
  },
  {
    q: "Is Digital Accounting and Book-keeping suitable for non-accountants?",
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 gap-4 text-left max-w-2xl mx-auto">
                {[
                  ...
                  { icon: <BarChart3 className="w-4 h-4" />, title: "Digital Accounting and Book-keeping", students: "340", rating: "4.7", weeks: "8 Wks", color: "#163d3a", hot: false, href: "/learn/management-school/accounting-software" },
                ].map((p) => (
