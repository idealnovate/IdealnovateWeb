  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-[5.5rem]">
        {/* Hero section */}
        <section className="relative bg-gradient-to-br from-[#163d3a] via-[#266D67] to-[#2d8a84] py-24 lg:py-36 overflow-hidden">
          {/* Background effects */}
          <div
            className="absolute inset-0 opacity-10"
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 50%, #f9ba48 0%, transparent 50%), radial-gradient(circle at 80% 30%, #2d8a84 0%, transparent 40%)",
            }}
          />
          <div
          ...
          {/* Floating orbs */}
          <div className="absolute top-10 left-20 w-40 h-40 rounded-full bg-[#f9ba48]/10 blur-3xl" />
          <div className="absolute bottom-10 right-20 w-60 h-60 rounded-full bg-white/5 blur-3xl" />

          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            {/* Coming Soon badge */}
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#f9ba48] text-white rounded-full text-sm font-bold mb-8 shadow-lg shadow-[#f9ba48]/30 font-[Montserrat]">
            ...
            <div className="relative inline-flex mb-8">
              ...
              <div className="absolute -top-2 -right-2 w-7 h-7 bg-[#f9ba48] rounded-full flex items-center justify-center">
            ...
            <h1 className="font-[Montserrat] font-bold text-4xl sm:text-5xl lg:text-6xl text-white leading-tight mb-5">
              The Idealnovate
              <br />
              <span className="text-[#f9ba48]">Marketplace</span>
            </h1>
            ...
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white mb-10">
              <div className="flex gap-1">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className="w-2 h-2 rounded-full bg-[#f9ba48]"
        ...
        <section className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="font-[Montserrat] font-bold text-3xl sm:text-4xl text-[#163d3a] leading-tight">
                A Marketplace Built for
                <span className="text-[#266D67]"> African Tech Professionals</span>
              </h2>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
              {categories.map((cat) => (
                <div
                  key={cat.name}
                  className="relative group bg-white border border-gray-100 rounded-2xl p-6 hover:border-[#266D67]/30 hover:shadow-xl hover:shadow-[#266D67]/8 transition-all duration-300"
                >
                  <div className="absolute top-4 right-4">
                    <span className="px-2 py-0.5 bg-[#eef6f5] text-[#266D67] text-xs font-bold rounded-full font-[Montserrat]">
                      Soon
                    </span>
                  </div>
                  ...
                  <h3 className="font-[Montserrat] font-bold text-[#163d3a] text-base mb-1">{cat.name}</h3>
            ...
            {/* Why Marketplace */}
            <div className="bg-[#163d3a] rounded-3xl p-8 lg:p-10 grid lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="text-center">
                  <h4 className="font-[Montserrat] font-bold text-[#f9ba48] text-lg mb-2">{item.title}</h4>
        ...
        {/* Back to home */}
        <section className="py-10 bg-[#f4f9f8]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#266D67] text-white font-bold rounded-lg hover:bg-[#163d3a] transition-all shadow-sm font-[Montserrat] text-sm"
            >
              ← Back to Homepage
            </Link>
          </div>
