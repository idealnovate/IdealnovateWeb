...
const paths = [
  {
    ...
    description: "Perfect for complete beginners. Build a solid foundation in your chosen tech field with bite-sized, structured lessons designed to fast-track your learning.",
    duration: "4–8 Weeks",
    modules: "12–16 Modules",
    students: "4,800+ enrolled",
    features: [
  ...
  },
  {
    ...
    description: "An elite, intensive programme for professionals ready to dominate their field. Think advanced strategy, leadership, and execution at the highest level.",
