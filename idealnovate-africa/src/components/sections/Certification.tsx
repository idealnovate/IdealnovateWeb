        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative max-w-md mx-auto lg:mx-0">
              {/* Shadow card */}
              <div className="absolute -bottom-4 -right-4 w-full h-full bg-[#eef6f5] rounded-3xl" />
              <div className="absolute -bottom-2 -right-2 w-full h-full bg-[#e2efee] rounded-3xl" />

              {/* Main certificate */}
              <div className="relative bg-white rounded-3xl border-2 border-[#266D67]/20 overflow-hidden shadow-2xl shadow-[#266D67]/15">
                {/* Header */}
                <div className="bg-gradient-to-r from-[#163d3a] to-[#266D67] p-6 text-white">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
                      <Award className="w-6 h-6 text-[#f9ba48]" />
                    </div>
                  </div>

                  <div>
                    <p className="text-white/60 text-xs font-[Montserrat] mb-1">This certifies that</p>
                    <p className="font-[Montserrat] font-bold text-2xl text-[#f9ba48]">Amara Osei</p>
                  </div>
                </div>

                <div className="p-6">
                  <p className="text-gray-500 text-sm font-[Montserrat] mb-1">has successfully completed</p>
                  <p className="font-[Montserrat] font-bold text-[#163d3a] text-lg mb-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    {["Figma", "User Research", "Prototyping", "Design Systems"].map((skill) => (
                      <span key={skill} className="px-2.5 py-1 bg-[#eef6f5] text-[#266D67] text-xs font-bold rounded-full font-[Montserrat]">
                        {skill}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div>
                      ...
                      <p className="text-xs font-bold text-[#266D67] font-[Montserrat]">ID: IDA-2025-04-001234</p>
                    </div>
                    <div className="w-10 h-10 rounded-xl bg-[#eef6f5] flex items-center justify-center">
                      <BadgeCheck className="w-5 h-5 text-[#266D67]" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {features.map((f) => (
                <div key={f.label} className="flex items-start gap-3 p-4 bg-[#f4f9f8] rounded-2xl border border-[#e2efee]">
                  <div className="w-9 h-9 rounded-xl bg-[#e2efee] flex items-center justify-center text-[#266D67] shrink-0">
                    {f.icon}
                  </div>
                  <div>
                    <p className="font-[Montserrat] font-bold text-[#163d3a] text-xs">{f.label}</p>
          ...
          {/* Right content */}
          <div>
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-[#eef6f5] text-[#266D67] text-sm font-semibold rounded-full mb-6 font-[Montserrat]">
            ...
            <h2 className="font-[Montserrat] font-bold text-3xl sm:text-4xl lg:text-5xl text-[#163d3a] leading-tight mb-5">
              ...
              <span className="text-[#266D67]"> Actually Opens Doors</span>
            </h2>
                ...
                <div key={step.step} className="flex items-start gap-4">
                  ...
                  <div className="pt-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-bold text-[#266D67] font-[Montserrat] bg-[#eef6f5] px-2 py-0.5 rounded-full">
                        Step {step.step}
                      </span>
                      <h4 className="font-[Montserrat] font-bold text-[#163d3a] text-sm">{step.title}</h4>
                    </div>
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 px-7 py-4 bg-[#266D67] text-white font-bold rounded-lg hover:bg-[#163d3a] transition-all shadow-sm font-[Montserrat] text-sm"
            >
